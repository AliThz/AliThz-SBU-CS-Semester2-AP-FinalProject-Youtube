...
public class ChannelPageController implements Initializable {
    ...
    private void displayVideos() {
        ...
        Platform.runLater(() -> {
            ...
            String response = YouTubeApplication.receiveResponse();
            Gson gson = new Gson();
            TypeToken<Response<Subscription>> subscriptionResponseTypeToken = new TypeToken<>() {
            };
            Response<Subscription> subscriptionResponse = gson.fromJson(response, subscriptionResponseTypeToken.getType());
